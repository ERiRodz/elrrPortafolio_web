// Array for storing all Games entries (object containing the Games information)
let gamesEntry = new Array();

// Games entry blueprint (Object blueprint)
function GamesEntryInfo (nombre, portada)
{
    this.nombre = nombre;
