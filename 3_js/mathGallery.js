// Array for storing all Math entries (object containing the Math information)
let mathEntry = new Array();

// Math entry blueprint (Object blueprint)
function mathEntryInfo (nombre, portada)
{
    this.nombre = nombre;
